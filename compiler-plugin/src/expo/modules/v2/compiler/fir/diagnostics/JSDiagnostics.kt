...
/**
 * The frontend diagnostics [expo.modules.v2.compiler.fir.JSCheckers] reports.
 */
...
object JSDiagnosticMessages : BaseDiagnosticRendererFactory() {
  override val MAP = KtDiagnosticFactoryToRendererMap("ExpoModulesV2").apply {
    ...
    put(
      ...
      "A @JS class must extend expo.modules.v2.modules.Module - that is what the registry " +
