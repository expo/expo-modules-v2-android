...
@Record
private data class Item(val x: Int, val b: String) : expo.modules.v2.records.Record

/** An optional field, so an inbound payload gates `text` with a presence byte. */
@Record
private data class Note(val v: Int, val text: String? = null) : expo.modules.v2.records.Record
