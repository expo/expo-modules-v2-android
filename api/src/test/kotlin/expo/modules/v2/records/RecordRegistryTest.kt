...
@Record
private data class Segment(val start: Point, val end: Point) : expo.modules.v2.records.Record
 ...
 */
@Record
private data class Badge(val id: Int, val title: String) : expo.modules.v2.records.Record
...
@Record
private data class Ping(val n: Int, val pong: Pong?) : expo.modules.v2.records.Record

@Record
private data class Pong(val n: Int, val ping: Ping?) : expo.modules.v2.records.Record
