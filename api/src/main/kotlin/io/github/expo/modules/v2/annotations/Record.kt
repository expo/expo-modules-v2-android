 ...
 *
 *  - it adds the `io.github.expo.modules.v2.records.Record` supertype, so the class does **not** declare it;
 ...
 *  - the codec registers itself in [io.github.expo.modules.v2.records.RecordRegistry] when the class loads.
 *
 * Reach the generated codec with [io.github.expo.modules.v2.records.codecFor]:
 *
 * ```kotlin
 * @Record
