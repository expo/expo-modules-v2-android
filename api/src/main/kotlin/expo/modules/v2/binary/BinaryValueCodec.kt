...
import expo.modules.v2.records.SchemaId
...
/**
 * The schema-directed codec a [expo.modules.v2.converters.TypeConverter]'s buffer pass writes and reads
    ...
    val type = RecordRegistry.typeFor(value.javaClass)
      ?: throw IllegalArgumentException(
        "No external schema registered for ${value.javaClass.name}; annotate the class with " +
          "@expo.modules.v2.annotations.Record, or call RecordRegistry.register before the " +
