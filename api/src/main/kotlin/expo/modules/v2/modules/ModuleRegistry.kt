...
import expo.modules.v2.binary.ModuleDescriptorEncoder
...
class ModuleRegistry {
  ...
  /**
   * Registers a module that declares its exports with [expo.modules.v2.annotations.JS]. The name and
  ...
  private fun add(name: String, module: Module, definition: ModuleBuilder) {
    ...
    modules[name] = Entry(module, definition.functions, definition.properties)
  }
